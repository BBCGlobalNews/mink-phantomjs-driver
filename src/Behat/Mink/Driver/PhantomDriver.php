...
class PhantomDriver implements DriverInterface
{
     ...
     */
    public function __construct($browserName = 'phantomjs', $desiredCapabilities = null, $wdHost = 'http://localhost:8643/wd/hub')
    {
    ...
    {
        try {
            $this->wdSession = $this->webDriver->session($this->browserName, null);
            $this->applyTimeouts();
        } catch (\Exception $e) {
